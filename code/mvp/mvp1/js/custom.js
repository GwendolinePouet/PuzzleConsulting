...
function map(){
    ...
    L.mapbox.featureLayer({        // Ceci est un marqueur
        ...
        properties: {
            title: 'Jean-Pierre',
            description: '&Agrave; augmenté sa productivité de 15% en 1 an',
            // one can customize markers by adding simplestyle properties
            // https://www.mapbox.com/guides/an-open-platform/#simplestyle
            'marker-size': 'large',
            'marker-color': '#3bb2d0',
    ...
    L.mapbox.featureLayer({        // Ceci est un marqueur
        ...
        properties: {
            title: 'Mr Cruz',
            description: '&Agrave; recruté de nouveaux collaborateurs',
            // one can customize markers by adding simplestyle properties
            // https://www.mapbox.com/guides/an-open-platform/#simplestyle
            'marker-size': 'large',
            'marker-color': '#3bb2d0',
    ...
    L.mapbox.featureLayer({        // Ceci est un marqueur
        ...
        properties: {
            title: 'Denneny',
            description: '&Agrave; ouvert un deuxième bureau<br />suite à une nette augmentation<br />du nombre de clients',
            // one can customize markers by adding simplestyle properties
            // https://www.mapbox.com/guides/an-open-platform/#simplestyle
            'marker-size': 'large',
            'marker-color': '#3bb2d0',
